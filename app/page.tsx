  ...
  return (
    <main>
      ...
      <section className="home-path page-shell">
        ...
        <div className="route-grid">
          {[
            ...
            ["03", "Викторина", "Төрт тақырып бойынша біліміңді тексеріп, XP жина.", "/quiz"],
            ["04", "Тапсырмалар", "Мұғалім берген жұмысты орындап, баға мен пікір ал.", "/assignments"],
            ["05", "Жоба жоспары", "Ғылыми жұмысты төрт нақты қадаммен құрастыр.", "/project"],
      ...
      <section className="home-path page-shell">
        ...
        <div className="route-grid four-up">
          {[
